...
- Plan-time vs convergence-time abstraction overview:
  - Mermaid viewer: [Open Diagram](../mmd-render.html?mmd=diagrams/plan-vs-convergence-abstraction.mmd&back=../articles.html)
